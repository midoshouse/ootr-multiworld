...
if (typeof PJ64_JSAPI_VERSION === 'undefined') {
                    ...
                    if (
                        ...
                        if (mem.u16[coopContextAddr + 0x8] == 0) {
                            ...
                            if (internalCount < externalCount) {
                                ...
                                mem.u16[coopContextAddr + 0x6] = item == 0x00ca ? (playerID == 1 ? 2 : 1) : playerID;
    ...
    //TODO automatically launch the companion app
    throw "Sorry, Project64 4.0+ is not yet supported. You can subscribe to https://github.com/midoshouse/ootr-multiworld/issues/13 for updates.";
} else {
