This is **Mido's House Multiworld**, an alternative implementation of [multiworld](https://wiki.ootrandomizer.com/index.php?title=Multiworld) for [the Ocarina of Time randomizer](https://ootrandomizer.com/) focusing on [cross-platform compatibility](https://midos.house/mw/platforms) and ease of use. ([Feature comparison](https://wiki.ootrandomizer.com/index.php?title=Multiworld#Feature_comparison) with [the existing implementation](https://github.com/TestRunnerSRL/bizhawk-co-op))
